...
void main() {
  ...
  //null 병합 연산자
  int? value1;
  int result1 = value1 ?? 100; //value1이 null이면 100대입
  print(result1);


  value1 = 50;
  int result2 = value1 ?? 200;  //최신 dart 컴파일러는 타입 체크를 통해 ?? 병핮연산자 써야함
  print(result2);
  ...
  print(nullableString?.toUpperCase()); //null 아닐경우 touppercase 호출
  ...
  // nullable 변술를 non-nullable변수에 직접 대입은 안됨,그래서 null 아님을 명확히 보호하기 위해 ! 사용
